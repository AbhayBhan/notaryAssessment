...
const Details = () => {
    ...
    return (
        <div className='container flex-col space-y-6 py-4 h-auto shadow-2xl bg-white flex md:fixed md:h-[100vh] md:w-[18vw] md:py-0'>
            ...
            <h1 className='text-3xl text-black font-bold mb-9 mx-auto'>{personaldetails.firstName}</h1>
            ...
            <div className='flex md:block justify-between'>
                ...
                <div className='md:flex flex-row px-4 mb-3 gap-4'>
                    ...
                    {/* Using area instead of complete address */}
                    <h6 className='text-black text-md font-medium hidden md:block'>{businessdetails.businessLocation.area}</h6> 
                </div>
                <div className='md:flex flex-row px-4 mb-3 gap-4'>
                    <img id='username' src={userIcon} width='20px' height='16px' onClick={(e)=>handleClick(e)}></img>
                    <h6 className='text-black text-md font-medium hidden md:block'>{personaldetails.username}</h6>
                </div>
            </div>
